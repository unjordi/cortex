...
> **Excluidos del release** (viven local/global, no en el índice compartido): `kde-tema-opaco` (machine-specific → memoria GLOBAL per-máquina) y `feedback_correr-comandos-sin-modificar` (lección personal/global).
