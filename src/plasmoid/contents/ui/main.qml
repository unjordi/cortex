    ...
    readonly property var brainTiers: [
        ...
        },
        {
            ...
            items: [
                ...
                { emoji: "🕹️", name: "control-gui-remota-por-ssh", desc: "ver/operar una GUI remota por SSH sin VNC/RDP — screenshot/click/teclado DPI-aware; Windows completo, Linux/Mac andamio",
                  event: "skill · opt-in",
